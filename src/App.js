    ...
    <div className="right-half">
        <div className="left-column">
            ...
            Exploring different cybersecurity projects is like diving into a practical learning adventure, where you encounter all sorts of challenges and real-life situations.
             ...
             <br />
        <p>Credits goes to:  <a href="https://github.com/bigbrodude6119/flipper-zero-evil-portal" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">bigbrodude6119</a>
